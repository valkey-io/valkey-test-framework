...
class TestExampleCommonSetupPerClass(ValkeyTestCase):
    """
    ...
    def setup_server_and_client(self):
        ...
        (
            TestExampleCommonSetupPerClass.common_server,
            TestExampleCommonSetupPerClass.common_client,
        ) = self.create_server(
    ...
    def test_basic1(self):
        ...
        TestExampleCommonSetupPerClass.common_client.execute_command("PING")

    @pytest.mark.order(2)
    def test_basic2(self):
        TestExampleCommonSetupPerClass.common_client.execute_command("PING")
        c = TestExampleCommonSetupPerClass.common_server.get_new_client()
        c.execute_command("PING")

    @pytest.mark.order(3)
    def test_basic3(self):
        TestExampleCommonSetupPerClass.common_client.execute_command("SET K V")
        TestExampleCommonSetupPerClass.common_server.exit()
